    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            <label for="name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-200">
                <i class="fas fa-user mr-1 text-indigo-600 dark:text-indigo-400"></i>
                {{ __('Name') }}
            </label>
            <input id="name" 
                   type="text" 
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors duration-200">
                <i class="fas fa-lock mr-1 text-indigo-600 dark:text-indigo-400"></i>
                {{ __('Confirm Password') }}
            </label>
